...
{{ Form::model($userrole, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('userroles.update', $userrole->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('userroles.show', 'Cancel', $userrole->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
